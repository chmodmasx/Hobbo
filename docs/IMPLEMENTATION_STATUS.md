...
- [x] Core simulation CI #283 (`35489123961`) completed green on the playable client commit, including workspace typecheck/unit tests, PostgreSQL migrations/repositories, realtime server integration and runtime integration.
